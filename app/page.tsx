      ...
      <section id="services" className="mx-auto max-w-7xl scroll-mt-24 px-6 pb-12 pt-14 sm:pt-16 lg:px-10 lg:pb-14 lg:pt-20">
        <motion.div {...fadeInUp} className="rounded-3xl border border-neutral-800 bg-[#0A0A0A] p-7 sm:p-8 lg:p-12">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <motion.button whileHover={{ scale: 1.02 }} animate={{ boxShadow: ['0 0 0px rgba(212,255,0,0.25)', '0 0 22px rgba(212,255,0,0.35)', '0 0 0px rgba(212,255,0,0.25)'] }} transition={{ duration: 2, repeat: Infinity }} className="rounded-full bg-[#D4FF00] px-7 py-3 font-bold text-black"><a href="#lead">Отримати консультацію</a></motion.button>
