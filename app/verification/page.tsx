...
export default function VerificationPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="mx-auto max-w-7xl px-4 pb-10 pt-20 sm:px-6 lg:px-10">
        <motion.div {...fadeInUp} className="rounded-3xl border border-[#D4FF00]/35 bg-[#0A0A0A] p-5 shadow-[0_0_30px_rgba(212,255,0,0.12)] sm:p-7 lg:p-10">
          <h1 className="text-2xl font-black sm:text-4xl">Безкоштовна інструкція: як верифікувати посвідчення водія самостійно</h1>
          <p className="mt-4 max-w-4xl text-[#A1A1AA] sm:text-lg">Ми підготували покрокову відеоінструкцію, у якій пояснюємо, коли потрібна верифікація посвідчення водія та як пройти цю процедуру самостійно.</p>
        </motion.div>
        <motion.div {...fadeInUp} className="mt-6 overflow-hidden rounded-3xl border border-neutral-800 bg-black shadow-[0_0_34px_rgba(212,255,0,0.18)]">
          <div className="aspect-video w-full">
            <iframe className="h-full w-full" src="https://www.youtube.com/embed/SHL0sNclDpM?si=OJjHN1XXqLasPofN" title="Безкоштовна інструкція: як верифікувати посвідчення водія самостійно" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen />
          </div>
        </motion.div>
      </section>
      <section className="mx-auto max-w-7xl px-6 pb-12 lg:px-10"><motion.div {...fadeInUp} className="rounded-3xl border border-neutral-800 bg-[#0A0A0A] p-7 lg:p-10"><h2 className="text-3xl font-black sm:text-5xl">В яких ситуаціях потрібна верифікація посвідчення водія?</h2><p className="mt-5 max-w-4xl text-[#A1A1AA] sm:text-lg">Верифікація допомагає оновити або підтвердити дані посвідчення в реєстрах МВС, щоб документ коректно відображався в Дії та електронних сервісах.</p></motion.div></section>
